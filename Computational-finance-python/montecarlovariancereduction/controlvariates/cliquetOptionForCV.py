...
class CliquetOptionForCV:
    ...
    def setNonTruncatedPayoffs(self, returnsForAllSimulations):
        """
        It returns the payoffs of the Cliquet option for all the simulations,
        not yet discounted
        ...
        #is a matrix, and not even that payoffSingleTrajectory accpet a vector
        #as an argument.
    ...
    def getPayoffs(self, returnsForAllSimulations, globalFloor = None, 
        ...
        if self.nonTruncatedPayoffs == None:
            self.setNonTruncatedPayoffs(returnsForAllSimulations)
