...
class Upwind(PricingWithPDEs):
    ...
    def getSolutionAtNextTime(self):
        """    
        It returns the solution at the next time step, via Upwind
        Parameters
        ----------
        None
        ...
        #this is the only difference with respect to Explicit Euler: we have 
        #backward derivatives because the term that multiplies the first derivative
        #in the PDE is negative
